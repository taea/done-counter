...
- 段数、目数、設定はローカルストレージに保存されます。同じブラウザならページを更新しても状態が維持されます。異なるブラウザ、デバイス間等での同期はできません。
- <img width="300" src="https://github.com/user-attachments/assets/6ccb5c03-ca19-4d6f-b42c-5984e029c4eb">
